...
|   |   | 2.2.1  | El sistema almacena las URL’s recabadas hasta el próximo periodo de guardado. |
...
|   |   | 4.2.1  | El sistema almacena la información recabada hasta el próximo periodo de guardado.  |
